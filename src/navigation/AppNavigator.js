...
// // AnimatedDrawer ko is se replace karo:
...
//     if (token) {
//         if (isAdmin) initialRoute = 'AdminMain';
//         else if (isHr) initialRoute = 'HrMain';
//         else if (isManager) initialRoute = 'ManagerMain';
//         else initialRoute = 'UserMain';
//     }
