...
//     useEffect(() => { setLoading(true); fetchReports(); }, [range]);
...
//             refreshControl={<RefreshControl refreshing={refreshing} onRefresh={() => { setRefreshing(true); fetchReports(); }} tintColor="#6366f1" />}
//         >
...
//                             <Text style={styles.statValue}>{reports?.totalCalls ?? 0}</Text>
//                             <Text style={styles.statLabel}>Total Calls</Text>
//                         </View>
//                         <View style={styles.statBox}>
//                             <Text style={[styles.statValue, { color: '#22c55e' }]}>{reports?.connected ?? 0}</Text>
//                             <Text style={styles.statLabel}>Connected</Text>
//                         </View>
//                     </View>
//                     <View style={styles.statRow}>
//                         <View style={styles.statBox}>
//                             <Text style={[styles.statValue, { color: '#ef4444' }]}>{reports?.missed ?? 0}</Text>
//                             <Text style={styles.statLabel}>Missed</Text>
//                         </View>
//                         <View style={styles.statBox}>
//                             <Text style={[styles.statValue, { color: '#f59e0b' }]}>{reports?.followUps ?? 0}</Text>
//                             <Text style={styles.statLabel}>Follow Ups</Text>
//                         </View>
//                     </View>

//                     {reports?.topAgent && (
//                         <View style={styles.topAgent}>
//                             <Text style={styles.topAgentLabel}>🏆 Top Agent</Text>
//                             <Text style={styles.topAgentName}>{reports.topAgent.name}</Text>
//                             <Text style={styles.topAgentCalls}>{reports.topAgent.calls} calls</Text>
//                         </View>
//                     )}
//                 </View>
//             )}
...
//     rangeRow: { flexDirection: 'row', justifyContent: 'center', gap: 10, marginBottom: 20 },
//     rangeBtn: {
...
//     },
//     topAgentLabel: { color: '#f59e0b', fontSize: 16, fontWeight: 'bold' },
//     topAgentName: { color: '#fff', fontSize: 20, fontWeight: 'bold', marginTop: 8 },
//     topAgentCalls: { color: '#6366f1', fontSize: 14, marginTop: 4 },
// });
